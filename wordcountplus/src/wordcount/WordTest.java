...
public class WordTest {
    ...
    public static void copyFile(String to)throws IOException{
        reader=new BufferedReader(new FileReader("wordcount/result.txt"));
        String result="";
        String str;
        while((str=reader.readLine())!=null)
            result=result+str+"\n";
    ...
    public static void main(String[] args)throws IOException{
        ...
        if(args.length==0){
            ...
            if(!args[0].equals("wordcount/-o")){//如果不是"-o"，则清除文件打开
                writer=new BufferedWriter(new FileWriter("wordcount/result.txt"));
            }
